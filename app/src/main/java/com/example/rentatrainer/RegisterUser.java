package com.example.rentatrainer;
...
public class RegisterUser extends AppCompatActivity implements View.OnClickListener{
    ...
    private void registerUser() {
        ...
        if(fullName.isEmpty()) {
            editTextFullName.setError("Full name is a requirement");
            editTextFullName.requestFocus();
            return;
        }

        if(age.isEmpty()){
            editTextAge.setError("Age is a requirement");
            editTextAge.requestFocus();
            return;
        }

        if(email.isEmpty()){
            editTextEmail.setError("Email is a requirement");
        ...
        if(password.isEmpty()){
            editTextPassword.setError("Password is a requirement");
